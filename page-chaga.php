...
?>
      ...
      <div class="accordion js-accordion section-about__accordion">
        <div class="accordion__item section-about__accordion-block">
          ...
          <div class="section-about__title-box js-accordion-trigger">
            ...
            <button class="u-hidden-o-sm section-about__trigger-btn"><img src="<?php echo get_template_directory_uri(); ?>/img/common/icon-circle-arrow.svg" alt="矢印"></button>
          </div>
          ...
          <button class="u-hidden-u-md section-about__trigger-btn js-accordion-trigger"><img src="<?php echo get_template_directory_uri(); ?>/img/common/icon-circle-arrow.svg" alt="矢印"></button>
        </div>
        <div class="accordion__item section-about__accordion-block">
          <p class="section-about__sub-title">チャーガの栄養</p>
          <div class="section-about__title-box js-accordion-trigger">
            <h2 class="section-about__title">体のサビ(酸化)とコゲ(糖化)を<br>防ぐチャーガの栄養素</h2>
            <button class="u-hidden-o-sm section-about__trigger-btn js-accordion-trigger"><img src="<?php echo get_template_directory_uri(); ?>/img/common/icon-circle-arrow.svg" alt="矢印"></button>
          </div>
          <div class="accordion__content section-about__content">
      ...
      <ul class="section-topics__card-list">
        ...
        <?php
          ...
          ?>
              ...
              <p class="topics-card__text"><?php echo $text; ?></p><p class="topics-card__link">more</p>
            </li>
    ...
    <section class="section-how-to-make">
      ...
      <ul class="section-how-to-make__contents">
        <li class="section-how-to-make__step"><img src="<?php echo get_template_directory_uri(); ?>/img/about/img-howto-make-1.png" alt="コップのイラスト1"></li>
        <li class="section-how-to-make__step"><img src="<?php echo get_template_directory_uri(); ?>/img/about/img-howto-make-2.png" alt="コップのイラスト2"></li>
        <li class="section-how-to-make__step"><img src="<?php echo get_template_directory_uri(); ?>/img/about/img-howto-make-3.png" alt="コップのイラスト3"></li>
        <li class="section-how-to-make__step"><img src="<?php echo get_template_directory_uri(); ?>/img/about/img-howto-make-4.png" alt="チャーガを飲んでいる女性のイラスト"></li>
      </ul>
