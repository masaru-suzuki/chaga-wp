...
?>
    ...
    <div class="contents-wrapper" id="js-contents-wrapper">
      ...
      <section class="section-efficacy">
        <h2 class="section-efficacy__title">チャーガに含まれる豊富な栄養成分が、<br>あなたの日々の健康維持をサポートいたします。</h2>
        <div class="section-efficacy__contents">
          <div class="section-efficacy__contents-wrapper">
            <ul class="section-efficacy__ingredient">
              <li class="js-efficacy-toggle is-active" id="ingredient-0">B-グルカン</li>
              <li class="js-efficacy-toggle" id="ingredient-1">ポリフェノール</li>
              <li class="js-efficacy-toggle" id="ingredient-2">マグネシウム</li>
              <li class="js-efficacy-toggle" id="ingredient-3">サポニン</li>
              <li class="js-efficacy-toggle" id="ingredient-4">エルゴステロール</li>
              <li class="js-efficacy-toggle" id="ingredient-5">ベツリン酸</li>
              <li class="js-efficacy-toggle" id="ingredient-6">マンガン</li>
              <li class="js-efficacy-toggle" id="ingredient-7">カルシウム</li>
              <li class="js-efficacy-toggle" id="ingredient-8">ナトリウム</li>
              <li class="js-efficacy-toggle" id="ingredient-9">フラボノイド</li>
              <li class="js-efficacy-toggle" id="ingredient-10">イノシトール</li>
              <li class="js-efficacy-toggle" id="ingredient-11">リグニン</li>
              <li class="js-efficacy-toggle u-hidden-u-lg" id="ingredient-12">メラニン</li>
            </ul>
            <div class="section-efficacy__description">
      ...
      <section class="section-belief">
        ...
        <div class="section-belief__contents">
          <div class="accordion js-accordion u-hidden-o-md">
          ...
          <ul class="section-belief__contents-title-box u-hidden-u-lg">
            <li>
              <h3 class="section-belief__contents-title js-belief-toggle is-active" id="belief-0"><span>01</span>ロシア産最高級チャーガ</h3>
            </li>
            <li>
      ...
      <section class="section-news">
        <h2 class="section-news__title">お知らせ</h2>
        <div class="section-news__wrapper">
          ...
          wp_reset_postdata(); ?>
        </div><a class="btn-type1" href="/info">もっと見る
          <div class="arrow"></div></a>
      </section>
