  ...
  <header class="site-header" id="js-header">
    <div class="site-header__wrapper">
      <div class="site-header__contents">
        <div class="js-btn-trigger" id="js-btn-trigger"><span></span><span></span><span></span></div><a class="site-header__brand" href="/"><img src="/img/common/logo.png" alt=""></a>
        <nav class="header-nav">
          <ul class="header-nav__wrapper">
            ...
            <li class="header-nav__item u-ml-30-lg"><a class="site-header__cart" href="https://shisui-chaga.myshopify.com/collections/all/" target="_blank"><img src="/img/common/icon_shop.svg" alt=""></a></li>
          </ul>
        </nav><a class="site-header__cart u-hidden-o-lg" href="https://shisui-chaga.myshopify.com/collections/all/" target="_blank"><img src="/img/common/icon_shop.svg" alt=""></a>
        <!-- global nav-->
        <nav class="global-nav" id="js-global-nav">
          <div class="contents">
            <div class="global-nav__logo-box"><img src="/img/common/logo-nav.png" alt=""></div>
            <ul class="global-nav__wrapper">
              ...
              <li class="global-nav__item is-outside-link">ご購入<a href="https://shisui-chaga.myshopify.com/collections/all/" target="_blank"></a><img src="/img/common/outside-link.svg" alt=""></li>
              ...
              <li class="global-nav__item is-instagram">Follow us<a href="https://www.instagram.com/shisuichaga/"></a><img src="/img/common/icon-logo-instagram.svg" alt=""></li>
            </ul><a class="global-nav__instagram" href="https://www.instagram.com/shisuichaga/" target="_blank">Follow us<img src="/img/common/icon-logo-instagram.svg" alt=""></a>
          </div>
        </nav>
      </div>
    </div>
